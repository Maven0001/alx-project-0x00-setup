      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Button
            ...
            styles="px-3 py-1 text-sm rounded-md"
          />
          <Button
            title="Small Rounded-lg"
            styles="px-3 py-1 text-sm rounded-lg"
          />
          <Button
            title="Small Rounded-full"
            styles="px-3 py-1 text-sm rounded-full"
          />
          ...
          <Button
            ...
            styles="px-4 py-2 text-base rounded-lg"
          />
          <Button
            title="Medium Rounded-full"
            styles="px-4 py-2 text-base rounded-full"
          />
          ...
          <Button
            ...
            styles="px-6 py-3 text-lg rounded-md"
          />
          <Button
